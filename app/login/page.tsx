...
// Pagina di login pubblica. Non richiede autenticazione.
// Se l'utente è già loggato, il middleware lo manda a /dashboard direttamente.
// =============================================================================
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-1 font-mono text-sm text-slate-500">Ritrova i tuoi amici, ovunque giochino</p>
        </div>
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-8">
            ...
            <div className="mb-6 px-4 py-3 rounded-xl bg-red-500/10 border border-red-500/20">
              <p className="font-mono text-xs text-red-400 text-center">
                {error === "OAuthAccountNotLinked"
                  ? "Email già usata con un altro provider."
          ...
          {/* GitHub OAuth — Server Action form */}
          <form
            action={async () => {
              "use server";
              await signIn("github", {
          ...
          <p className="mt-6 font-mono text-[10px] text-slate-600 text-center leading-relaxed">
            ...
            <br />
            Il tuo account GitHub non verrà modificato.
          </p>
        </div>
      </div>
    </div>
