      ...
      ">
        ...
        <nav className="hidden md:flex items-center gap-1">
          {[
            ...
            { href: `/dashboard/profile/${user.username}`,     label: "Profilo" },
          ].map(({ href, label }) => (
        ...
        {/* Avatar — cliccabile verso il proprio profilo */}
        <Link href={`/dashboard/profile/${user.username}`}
          className="w-8 h-8 rounded-xl overflow-hidden bg-gradient-to-br from-purple-600 to-purple-900 flex items-center justify-center shrink-0 hover:ring-2 hover:ring-purple-500/50 transition-all">
          {user.image ? (
        ...
        ">
          ...
          <nav className="flex flex-col gap-0.5 mb-6">
            {[
              ...
              { href: `/dashboard/profile/${user.username}`,     label: "Profilo", d: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" },
            ].map(({ href, label, d }) => (
              <Link key={href} href={href}
